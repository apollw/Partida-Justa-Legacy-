...
namespace Partida_Justa.Models
{
    internal class MainViewModel
    {
        static void Main(string[] args)
        {
            ...
            //Listas temporárias para guardar jogadores baseados no Nível de cada um
            List<JogadorViewModel> listaNCinco = new List<JogadorViewModel>(); //Lista geral de todos os jogadores
            List<JogadorViewModel> listaNQuatro = new List<JogadorViewModel>(); //Lista geral de todos os jogadores
            List<JogadorViewModel> listaNTres = new List<JogadorViewModel>(); //Lista geral de todos os jogadores
            List<JogadorViewModel> listaNDois = new List<JogadorViewModel>(); //Lista geral de todos os jogadores
            List<JogadorViewModel> listaNUm = new List<JogadorViewModel>(); //Lista geral de todos os jogadores
